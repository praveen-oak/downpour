...
#SBATCH --job-name=3_workers_2_steps
#SBATCH --nodes=4
#SBATCH --ntasks-per-node=1
#SBATCH --output=3_workers_2_steps.out
#SBATCH --error=3_workers_2_steps.error
...
workers=8
opt='adam'
num_proc=4 # number of processors, must be equal to #SBATCH --nodes
